...
The current stable release is version 2.2.6. This repository is structured as a HACS custom repository and already includes the required
...
Die aktuelle stabile Version ist 2.2.6. Das Repository ist als Custom Repository für HACS strukturiert und enthält bereits die benötigten
